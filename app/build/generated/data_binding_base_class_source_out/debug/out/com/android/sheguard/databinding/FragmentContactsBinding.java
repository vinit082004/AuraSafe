...
public final class FragmentContactsBinding implements ViewBinding {
  ...
  private FragmentContactsBinding(@NonNull CoordinatorLayout rootView,
      @NonNull ViewHeaderExpandableBinding header, @NonNull RecyclerView recyclerView,
      @NonNull MaterialTextView tvEmptyList) {
  ...
  public static FragmentContactsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentContactsBinding((CoordinatorLayout) rootView, binding_header, recyclerView,
          tvEmptyList);
    }
