...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        binding.safetyVideos.setOnClickListener(v -> Navigation.findNavController(view).navigate(R.id.action_homeFragment_to_safetyVideosFragment));
        binding.hospitalAds.setOnClickListener(v -> {
            Intent intent = new Intent(Intent.ACTION_SENDTO);
            intent.setData(Uri.parse("mailto:vinitvyaduvanshi@gmail.com"));
    ...
    private void initializeDrawerItems() {
        ((NavigationView) requireActivity().findViewById(R.id.navView)).setNavigationItemSelectedListener(item -> {
            ...
            else if (id == R.id.nav_psnm) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.co.in/maps/search/police+station+near+me"));
                binding.getRoot().getContext().startActivity(intent);
            }

            else if (id == R.id.nav_hsnm) {
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.google.co.in/maps/search/hospital+near+me"));
                binding.getRoot().getContext().startActivity(intent);
            }
