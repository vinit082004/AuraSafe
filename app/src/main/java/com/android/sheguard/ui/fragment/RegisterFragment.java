...
public class RegisterFragment extends Fragment {
    ...
    private boolean isInformationValid() {
        ...
        if (Objects.requireNonNull(binding.bloodGroup.getText()).toString().trim().isEmpty()) {
            binding.bloodGroupLayout.setError(getString(R.string.please_enter_your_blood_group));
            isValid = false;
        } else {
            binding.bloodGroupLayout.setErrorEnabled(false);
            binding.bloodGroupLayout.setError(null);
        }
    ...
    private void saveUserInDatabase() {
        UserModel user = new UserModel(
                ...
                Objects.requireNonNull(binding.bloodGroup.getText()).toString().trim(),
                Objects.requireNonNull(binding.etEmail.getText()).toString().trim(),
